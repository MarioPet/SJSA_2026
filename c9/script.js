...
// const client = new BankAccount("Mario", 500);
// client.deposit(100);
// console.log(client);
...
// const admin = new Admin("John", 54, "super admin");
// const user_for_deletion = new User("Pero", 65);
// admin.deleteUser(user_for_deletion);
// console.log(admin);
...
// const new_instance = new MathHelper();
// // new_instance.add(5, 10);
...
//         return `${user.name} purchased ${quantity} ${product.name}(s).`;
//     }
// }

// try {
//     const shop = new Shop();
//     const user_one = new User("Mario", "mario5etkovski@gmail.com");
//     const laptop = new Product("Laptop", 1200, 5);

//     shop.registerUser(user_one);
//     shop.addProduct(laptop);

//     const result = shop.purchase("mario5etkovski@gmail.com", "Laptop", 2);
